  ...
  return (
    <Card className="max-w-sm">
      ...
      <Input 
        ...
        />
        <Button size="md" radius="sm" className="bg-blue-normal text-white font-medium text-base mt-2">Đăng ký</Button>
      </CardBody>
      <CardFooter className="flex flex-col">
      <div className="flex items-center">
            <span className="text-sm">Bạn đã có tài khoản? 
                <Link href="/login" className="ml-1 text-sm text-blue-normal hover:underline">
                    Đăng nhập ngay
                </Link>
            </span>
        </div>
