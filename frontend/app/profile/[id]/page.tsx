    ...
    return (
      <main className='min-h-[80vh] max-h-screen bg-gray-50 p-5'>
        {/* <div className='md:container'> */}
            <div className='flex flex-col items-center mx-auto w-full md:container'>
                ...
                <div className="max-w-6xl w-10/12 flex w-full items-center justify-between">
                    <form className="w-full mb-5 max-h-[65vh] md:max-h-[90vh] overflow-y-auto" onSubmit={handleSubmit}>
