...
export class CreateAboutusDto {
    @ApiProperty({ description: 'Title of the About Us section', enum: ["Achievement", "Intro", "OurValue", "OurVision"] })
    @IsString()
    @IsIn(["Achievement", "Intro", "OurValue", "OurVision"])
    category: "Achievement" | "Intro" | "OurValue" | "OurVision"; // Tiêu đề của phần "About Us" 

    @ApiProperty({ description: 'Title of the About Us section'})
    @IsString()
